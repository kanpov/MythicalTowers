...
sealed class MeleeRobotEntityRenderer(
    ...
    : MobEntityRenderer<MeleeRobotEntity, MeleeRobotEntityModel>(context, MeleeRobotEntityModel(context.getPart(EntityModelLayerRegistry.MELEE_ROBOT)), 0.1f) {
...
class GreenMeleeRobotEntityRenderer(context: EntityRendererFactory.Context)
    : MeleeRobotEntityRenderer(context, idOf("textures/entity/green_melee_robot.png"))

class YellowMeleeRobotEntityRenderer(context: EntityRendererFactory.Context)
    : MeleeRobotEntityRenderer(context, idOf("textures/entity/yellow_melee_robot.png"))

class OrangeMeleeRobotEntityRenderer(context: EntityRendererFactory.Context)
    : MeleeRobotEntityRenderer(context, idOf("textures/entity/orange_melee_robot.png"))

class RedMeleeRobotEntityRenderer(context: EntityRendererFactory.Context)
    : MeleeRobotEntityRenderer(context, idOf("textures/entity/red_melee_robot.png"))

class BlueMeleeRobotEntityRenderer(context: EntityRendererFactory.Context)
    : MeleeRobotEntityRenderer(context, idOf("textures/entity/blue_melee_robot.png"))

class PurpleMeleeRobotEntityRenderer(context: EntityRendererFactory.Context)
    : MeleeRobotEntityRenderer(context, idOf("textures/entity/purple_melee_robot.png"))

class GrayMeleeRobotEntityRenderer(context: EntityRendererFactory.Context)
    : MeleeRobotEntityRenderer(context, idOf("textures/entity/gray_melee_robot.png"))

class BlackMeleeRobotEntityRenderer(context: EntityRendererFactory.Context)
    : MeleeRobotEntityRenderer(context, idOf("textures/entity/black_melee_robot.png"))
